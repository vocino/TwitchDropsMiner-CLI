...
export const historyCommand = new Command("history")
    ...
    if (pruneOpt !== undefined) {
        ...
        if (opts.json) {
            ...
            console.log(JSON.stringify({ pruned: removed, days: effective, backend, stateDir: paths.stateDir, dbPath: paths.dbPath, jsonlPath: paths.jsonlPath }, null, 2));
        }
        else {
            // eslint-disable-next-line no-console
