...
import {
  assertNoGqlPersistedQueryFailure,
  GqlPersistedQueryMismatchError
} from "../../integrations/gqlClient.js";
...
test("assertNoGqlPersistedQueryFailure throws on persisted query mismatch", () => {
  assert.throws(
    () =>
      assertNoGqlPersistedQueryFailure(GQL_OPERATIONS.Inventory, {
        errors: [{ message: "PersistedQueryNotFound" }]
      }),
    (e: unknown) =>
      e instanceof GqlPersistedQueryMismatchError &&
