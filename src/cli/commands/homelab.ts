...
import { loadHooks, saveHooks } from "../../ops/webhooks.js";
import { getHistoryPaths, summarizeHistory, readRecentTicks } from "../../ops/history.js";
...
export const exportCommand = new Command("export")
  ...
  .action(async (opts) => {
    ...
    const what = String((opts as any).what || "history").toLowerCase();
    const limit = Math.max(1, Number((opts as any).limit) || 1000);

    const emitJSON = (obj: unknown) => console.log(JSON.stringify(obj, null, 2));
